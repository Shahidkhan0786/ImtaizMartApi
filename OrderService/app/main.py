...
from app.kafka.handlers import handle_user_response, handle_validate_token_responses,handle_payment_response
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    try:
        ...
        kafka_consumer.subscribe(["payment_response_topic"], handle_payment_response)
